      ...
      <div className="mx-auto flex w-[90%] flex-col items-center lg:max-w-[1212px]">
        ...
        <div className="flex w-full flex-col lg:max-w-[1200px] lg:flex-row lg:gap-24">
          ...
          <div className="mb-16 flex w-full flex-col gap-6 text-[18px] font-medium leading-relaxed text-white/70 md:text-[20px] lg:text-[24px]">
            <AnimatedBody text="I specialize in crafting high-converting landing pages and websites for SaaS, Web3 & AI startups. I'm passionate about building software that makes a difference." />
            <AnimatedBody text="Beyond my work as a frontend developer, I'm an active leader in tech communities and love experimenting with new technologies." />
            <AnimatedBody text="When I'm not coding, you’ll find me discovering new music, watching anime, or exploring new ideas." />
          </div>

          {/* Right content */}
          <div className="mb-16 flex w-full flex-col gap-8 text-[16px] leading-relaxed text-white/50 lg:max-w-[30%]">
            <div>
              <AnimatedTitle text="Frontend Tools" className="text-[20px] text-white" />
              <AnimatedBody text="JavaScript, React, Next.js, TypeScript, Redux, Git/GitHub." />
            </div>

            <div>
              <AnimatedTitle text="UI Libraries" className="text-[20px] text-white" />
              <AnimatedBody text="Tailwind CSS, Framer Motion, GSAP, Chart.js." />
            </div>

            <div>
              <AnimatedTitle text="Design Tools" className="text-[20px] text-white" />
