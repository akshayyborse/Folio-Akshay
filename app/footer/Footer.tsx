...
const Footer = () => {
  ...
  return (
    <motion.section
      className=" h-[15vh] w-full  items-center justify-center border-t-[3px] border-[#e4ded7]/30 bg-[#000000] pt-10  font-bold uppercase md:h-[20vh] md:py-16 lg:h-[10vh] lg:pt-6 lg:pb-0"
      initial="initial"
      animate="animate"
    >
        ...
        <div className="flex flex-col sm:flex-row  sm:gap-1 md:gap-2">
          ...
          >
            <span className="underline underline-offset-2 hover:no-underline">
              <AnimatedBody text={"Akshay Borse"} className={"m-0 p-0"} />
            </span>{" "}
          </Link>
        </div>
      </motion.div>
